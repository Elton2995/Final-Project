...
async def update_user_role(
    ...
    notification_crud.create_notification(
        ...
        data={"old_role": old_role.value, "new_role": role_data.role.value}
    )
...
async def update_user_status(
    ...
    notification_crud.create_notification(
        ...
        message=f"Your account status has been changed from {old_status.value} to {status_data.status.value}.",
        notification_type="system",
        data={"old_status": old_status.value, "new_status": status_data.status.value}
    )
